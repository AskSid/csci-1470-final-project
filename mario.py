...
class ConvertToPyTorch(gym.ObservationWrapper):
    def __init__(self, env):
        super(ConvertToPyTorch, self).__init__(env)
...
run(training_mode=True, pretrained=False, num_episodes=2, exploration_max = 1)

print("Training done.")

run(training_mode=False, pretrained=True, num_episodes=1, exploration_max = 1)