...
# For training
#run(training_mode=True, pretrained=False, double_dqn=True, num_episodes=500, exploration_max = 1)

print("TEST")

# For Testing
run(training_mode=False, pretrained=True, double_dqn=True, num_episodes=1, exploration_max = 1)